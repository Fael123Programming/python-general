...
print(showArgs(*listOfNumbers))  # Each element in listOfNumbers is considered as one argument passed to the function call.
...
print(report(**a_person))  # This dict will be unpackage and its couples of keyword-value will be passed to this function as we did above.
...
print(calc(name="Rafael", state="on", number1=100, maximum_size=300, number2=50))  # This is random set of key-value couples.
