...
my_account = Account()
# Python differs a little of Java: it always has a constructor function. Its name is __new__() and
...
# __new__()  -> intrinsic function responsible for creating a raw object;
